...
export const useMatiereStore = defineStore("matieres", {
    state: () => ({
        all: {
            loading: true,
            data: [],
    ...
    actions: {
        ...
        async publishedOne(data) {
            try {
                return await axiosClient.put("/matieres/" + data.id + "/publish");
            } catch (error) {
                console.log(error);
            }
        },
        async unPublishedOne(data) {
            try {
                return await axiosClient.put("/matieres/" + data.id + "/unpublish");
            } catch (error) {
                console.log(error);
            }
        },
        async publishedAll(datas) {
            ...
            try {
                return await axiosClient.put("/matieres/publish", {
                    ids: idsToPusblish,
                    headers: {
        ...
        async unPublishedAll(datas) {
            ...
            try {
                return await axiosClient.put("/matieres/unpublish", {
                    ids: idsToUnPusblish,
                    headers: {
                        "Content-Type": "application/json",
                    },
        ...
        async deleteAll(datas) {
            ...
            try {
                return await axiosClient.delete("/matieres", {
