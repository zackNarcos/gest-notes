...
export const useClasseStore = defineStore("classe", {
    ...
    actions: {
        ...
        async publishedOne(data) {
            try {
                return await axiosClient.put("/classes/" + data.id + "/publish");
            } catch (error) {
                console.log(error);
            }
        },
        async unPublishedOne(data) {
            try {
                return await axiosClient.put("/classes/" + data.id + "/unpublish");
            } catch (error) {
                console.log(error);
            }
        },
        async publishedAll(datas) {
            ...
            try {
                return await axiosClient.put("/classes/publish", {
                    ids: idsToPusblish,
                    headers: {
        ...
        async unPublishedAll(datas) {
            ...
            try {
                return await axiosClient.put("/classes/unpublish", {
                    ids: idsToUnPusblish,
                    headers: {
                        "Content-Type": "application/json",
                    },
        ...
        async deleteAll(datas) {
            ...
            try {
                return await axiosClient.delete("/classes", {
